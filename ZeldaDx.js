//J'ai fait -50px pour tout les divs pour que ça colle avec le background (et pour enlever la barre en haut sur Y)
...
function loadNewAnimation() {
  ...
  document.getElementById("divzdxTalTalMountainc").style.top = "0px"; //+50

  var jadsdsEnginemapmapzdxTalTalMountainc = new JadsdsEngine(
    "mapzdxTalTalMountainc"
  );
  jadsdsEnginemapmapzdxTalTalMountainc.fixCanvasSize = false;
  jadsdsEnginemapmapzdxTalTalMountainc.loadAnimationScreen =
    "zdxTalTalMountaincLoading";
  ...
  document.getElementById("divzdxTalTalMountainb").style.top = "0px";

  var jadsdsEnginemapzdxTalTalMountainb = new JadsdsEngine(
    "mapzdxTalTalMountainb"
  );
  jadsdsEnginemapzdxTalTalMountainb.fixCanvasSize = false;
  jadsdsEnginemapzdxTalTalMountainb.loadAnimationScreen =
    "zdxTalTalMountainbLoading";
  ...
  document.getElementById("divzdxTalTalMountain").style.top = "0px";

  var jadsdsEnginemapzdxTalTalMountain = new JadsdsEngine(
    "mapzdxTalTalMountain"
  );
  jadsdsEnginemapzdxTalTalMountain.fixCanvasSize = false;
  jadsdsEnginemapzdxTalTalMountain.loadAnimationScreen =
    "zdxTalTalMountainLoading";
  ...
  document.getElementById("divzdxForest").style.top = "512px";
  ...
  document.getElementById("divzdxCastle").style.top = "480px";
  ...
  document.getElementById("divzdxFalls").style.top = "480px";
  ...
  document.getElementById("divzdxMabe").style.top = "1040px";
  ...
  document.getElementById("divzdxUkuku").style.top = "1040px";
  ...
  document.getElementById("divzdxFaceShrine").style.top = "976px";
  ...
  document.getElementById("divzdxMabeb").style.top = "1520px";
  ...
  document.getElementById("divzdxLake").style.top = "1520px";
  ...
  document.getElementById("divzdxDesert").style.top = "1520px";
